...
configure_firewall() {
    while true; do
        ...
        echo "7. 🔧 Расширенное управление правилами"
...
# Расширенное управление UFW правилами (перенесено из SSH модуля)
manage_ufw_rules() {
    clear
    log_info "🔧 Расширенное управление UFW правилами"
    echo
    ...
    while true; do
        clear
        echo -e "${BLUE}╔══════════════════════════════════════╗${NC}"
        echo -e "${BLUE}║    Расширенное управление UFW        ║${NC}"
        echo -e "${BLUE}╚══════════════════════════════════════╝${NC}"
        echo
